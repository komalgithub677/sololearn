      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div>
            ...
            {myFooter.map((Footer) => (
              <Link to={Footer.link}><li ><style>{`li{margin-top:10px}`}</style>{Footer.title}</li></Link>
            ))}
            </ul>
          </div>
          ...
          <div>
            ...
            {myFeatures.map((Features) => (
              <Link to={Features.link}><li ><style>{`li{margin-top:10px}`}</style>{Features.title}</li></Link>
            ))}
            </ul>
          </div>
